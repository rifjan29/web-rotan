...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <h1 class="h3 mb-3"><strong>Tambah Our Teams</strong></h1>
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('our-teams.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                    ...
                                    <textarea id="summernote" name="motivasi" type="text" cols="200" rows="10" class="form-control @error('motivasi') is-invalid @enderror" value="{{ old('motivasi')}}"></textarea>
                                    @error('motivasi')
