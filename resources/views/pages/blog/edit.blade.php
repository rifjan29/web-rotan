                        ...
                        <form action="{{ route('blog.update',$data->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="id_kategori" id="select" class="form-control  @error('id_kategori') is-invalid @enderror">
                                    ...
                                    @foreach ($data_kategori as $item)
                                        <option value="{{ $item->id }}" {{ $data->id_kategori_blog == $item->id ? 'selected' : '' }} >{{$item->kategori_blog}}</option>
                                    @endforeach
                                    </select>
                                @error('id_kategori')
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-lg-4 img__data">
                                    <img src="{{ asset('images/blog/'.$data->photos) }}" alt="" style="bg-dark img-fluid w-75"  id="photosPreview">
                                </div>
                                <div class="col-lg-8">
