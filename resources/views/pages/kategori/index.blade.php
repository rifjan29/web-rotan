...
<div class="container-fluid p-0">
    <div class="row justify-content-between">
        <div class="col ">
            <h1 class="h3 "><strong>Kategori Produk</strong></h1>
        </div>
        <div class="col d-flex justify-content-end">
            <a href="{{ route('kategori.create')}}" class="btn btn-info mb-3" role="button">+ Tambah Data</a>
        </div>
    </div>
        <div class="row">
            <div class="col-lg-12">
                                ...
                                @foreach ($kategori as $item)
                                    <tr>
                                        ...
                                        <td class="align-middle"><center>
                                            <a href="{{ route('kategori.edit', $item->id ) }}" class="btn btn-sm btn-info btn-circle">
                                                <i class="ti-pencil"></i>
                                            </a>
                                            |
