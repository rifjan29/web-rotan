                    ...
                    <div class="card-body">
                        <form action="{{ route('produk.update',$data->id ) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="nm_rule" class="form-label">Nama Produk<small class="text-danger"> *</small></label>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="id_kategori" id="select" class="form-control  @error('id_kategori') is-invalid @enderror">
                                    ...
                                    @foreach ($dataKategori as $item)
                                        <option value="{{ $item->id }}" {{ $data->id_kategori_product == $item->id ? 'selected' : '' }} > {{ $item->name }}</option>
                                    @endforeach
                                    </select>
                                @error('id_kategori')
                            ...
                            <div class="form-group mb-3">
                                    ...
                                    <textarea id="summernote" name="deskripsi" type="text" cols="200" rows="10" class="form-control @error('deskripsi') is-invalid @enderror" value="{{ old('deskripsi')}}">{!! $data->desc !!}</textarea>
                                    @error('deskripsi')
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-lg-4 img__data">
                                    <img src="{{ asset('images/product/'.$data->photos ) }}" alt="" style="bg-dark img-fluid w-75"  id="photosPreview">
                                </div>
                                <div class="col-lg-8">
